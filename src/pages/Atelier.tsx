  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main>        
        ...
        <section className="py-20 px-6 md:px-12 lg:px-20 bg-background">
        <p>
            Если Вы в поисках "того самого" корсета или платья, добро пожаловать! 
        </p>
        <p>
            Приходите к нам с чёткими идеями или без них — поможем, подскажем, сошьём красиво и в срок
        </p>
        </section>
      </main>
      <Footer />
